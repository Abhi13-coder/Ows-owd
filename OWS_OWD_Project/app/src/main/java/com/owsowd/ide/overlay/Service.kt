...
class OverlayService : Service() {
    ...
    private fun addOverlay(ows: String, owd: String?, preferredId: String?) {
        ...
        if (result.scene == null || vmInstance == null) return
        ...
        val host: android.view.View = try {
            ...
            // Canvas fallback
            OverlayHostView(this, id, result.scene, vmInstance) { overlayId ->
        ...
        try {
            ...
            overlays[id] = OverlayInstance(id, host, params, result.scene, vmInstance)
            updateNotification()
        } catch (e: Exception) {
            e.printStackTrace()
        }
